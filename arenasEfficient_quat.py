...
from ray_tracing_simulator_nnModules_grad_quat import Prism, Ray, Plane, ReflectingPlane, RefractingPlane, EfficientCamera, visualize_camera_configuration, closest_point, rotx, get_rot_mat
...
class Arena_reprojection_loss_two_cameras(nn.Module):
    def __init__(self, 
    principal_point_pixel_cam_0, 
    principal_point_pixel_cam_1, 
    focal_length_cam_0, 
    ...
    prism_angles=None,
    prism_center=None):
        super(Arena_reprojection_loss_two_cameras, self).__init__()
    ...
    def forward(self, pixels_virtual_two_cams, pixels_real_two_cams):
        ...
        recon_undistorted_real_pixels_cam_1 = camera2.reproject(recon_3D_real, R2, R2 @ T2)
        ...
        recon_pixels_2 = camera2.reproject(recon_3D, R2, R2 @ T2)
        ...
        recon_undistorted_virtual_pixels_cam_1 = camera2.reproject(recon_3D_virtual, R2, R2 @ T2)
...
class Arena_two_real_cameras_grid_distance_quat(nn.Module):
    def __init__(self, 
    principal_point_pixel_cam_0,
    principal_point_pixel_cam_1,
    focal_length_cam_0,
    ...
    prism_angles=None,
    prism_center=None):
        super(Arena_two_real_cameras_grid_distance_quat, self).__init__()
...
class Arena_two_real_cameras_grid_distance(nn.Module):
    ...
    def forward(self, pixels_real_two_cams):
        ...
        recon_loss_real = recon_loss_real[:num_points]
        return recon_3D, closest_distance, recon_distorted_real_pixels_cam_0, recon_distorted_real_pixels_cam_1, recon_loss_real, pairwise_distance
