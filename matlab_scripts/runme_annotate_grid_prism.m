...
grid_disp_thresh = 0.1; % (in pixels) How far should the grid points move to accept a new grid position. The chosen threshold is generally what calibration accuracy is
